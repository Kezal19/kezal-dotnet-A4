...
namespace Employee_3
{
    class Program
    {
        ...
        {
            Employee e1 = new Employee("Meera","Patel",50000);
            Employee e2 = new Employee("Ayesha","Desai",60000);
            ...
            PermanentEmployee pe1 = new PermanentEmployee("Meera","Patel",50000,7000,500,4500,"01-01-2022","10-05-2022");

            PermanentEmployee pe2 = new PermanentEmployee("Ayesha","Desai",60000,9000,1000,9500,"01-02-2022","01-06-2022");
